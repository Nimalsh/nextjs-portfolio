...
const downloadCV = () => {
  ...
  link.href = "/Nimalsha_CV.pdf";
  link.download = "Nimalsha_Maduwathi_CV.pdf";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold">
            ...
            <br />
            <TypeAnimation
              sequence={["Nimalsha", 1000, "Maduwnathi", 1000, "Quality Engineer", 1000]}
              wrapper="span"
              speed={50}
              repeat={Infinity}
            />
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            ISTQB® Certified Quality Engineer specializing in manual and automated testing
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            {/* ✅ Replaced <a> with <button> to trigger downloadCV */}
            <button
              onClick={downloadCV}
